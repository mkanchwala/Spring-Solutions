...
Import as *Existing Maven Project* and run it as *Spring Boot App*.
 ...
 INSERT into language(description,name) VALUES ('Some Sample', 'Hindi');
 INSERT INTO user(email,username,preferred_language) VALUES ('imkanchwala@gmail.com','mkanchwala',1);
 INSERT INTO country(capital,code,description,name,population) VALUES ('New Delhi','IN','Indian Subcontinent','India',120000000);